...
namespace RootCards.Cards
{
    class Genie : CustomCard
    {
        ...
        public override void OnAddCard(Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            ...
            characterStats.GetRootData().freeCards += 1;
        ...
        {
            return "Ask and ye shall recive. (When you are ready to use your wish, type in chat and the Genie will try to give you the closest named card to what you said.)";
        }
